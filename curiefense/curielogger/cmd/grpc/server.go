...
func (s *grpcServer) buildCfLog(req *ald.HTTPRequestProperties, common *ald.AccessLogCommon, curieProxyLog entities.CurieProxyLog, respFlags *ald.ResponseFlags, tls *ald.TLSProperties, lan []string, pan []string, resp *ald.HTTPResponseProperties) entities.CuriefenseLog {
	...
	return entities.CuriefenseLog{
		...
		Downstream: entities.Downstream{
			...
			DirectRemoteAddressPort: int32(common.GetDownstreamDirectRemoteAddress().GetSocketAddress().GetPortValue()),
			LocalAddress:            common.GetDownstreamLocalAddress().GetSocketAddress().GetAddress(),
			LocalAddressPort:        int32(common.GetDownstreamLocalAddress().GetSocketAddress().GetPortValue()),
			...
			RemoteAddressPort:       int32(common.GetDownstreamRemoteAddress().GetSocketAddress().GetPortValue()),
		},
		Upstream: entities.Upstream{
			...
			LocalAddressPort:       int32(common.GetUpstreamLocalAddress().GetSocketAddress().GetPortValue()),
			Overflow:               respFlags.GetUpstreamOverflow(),
			RemoteAddress:          common.GetUpstreamRemoteAddress().GetSocketAddress().GetAddress(),
			RemoteAddressPort:      int32(common.GetUpstreamRemoteAddress().GetSocketAddress().GetPortValue()),
		...
		Request: entities.Request{
			...
			BodyBytes:    int64(req.GetRequestBodyBytes()),
			HeadersBytes: int64(req.GetRequestHeadersBytes()),
		...
		Response: entities.Response{
			...
			HeadersBytes: int64(resp.GetResponseHeadersBytes()),
