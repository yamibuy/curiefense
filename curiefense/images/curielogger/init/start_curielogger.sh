...
create_index () {
	...
	curl --silent -X POST "http://$CURIELOGGER_KIBANA_HOST:5601/$PATTERN_PATH" -H 'Content-Type: application/json' -H 'kbn-xsrf: true' -d '{"attributes": {"title": "curieaccesslog","timeFieldName": "@timestamp"}}'
}
